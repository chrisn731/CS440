...
static const char *action = "RDLDDDLRUDDDUDRRRRLLULLLRDRDLUDDRLLDLDRLUUDULRRUUDDUDLDUDRRRDRLLRDLRRRRULRULLRUUULULDDUUDDULLDRRURDD";
static const char *sensor = "NNTTNNNTTHHTTHTNNNTHTNNTNTTNNTTTTTTNTNTNTNTHHNNTHHNNNHTHNTNNTTNNNTHTNTNTHNNNTTTTNTNHNTNNTHTTHNNNTHHH";
		...
		const char *action, double *prev)
{
	...
	do_filter(world, ++state, ++action, summation);
	free(summation);
}
